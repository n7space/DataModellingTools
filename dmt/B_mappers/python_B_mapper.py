...
def OnStartup(modelingLanguage: str,
    ...
    if maybeFVname + modelingLanguage.lower() not in g_perFV:
        ...
        if modelingLanguage.lower() == "gui_pi":
            ...
            g_bodyPython.append('            queue_name = str(os.geteuid()) + "_' + maybeFVname + '_PI_Python_queue"')
            g_bodyPython.append('            self._msgQueue = OpenMsgQueueForReading(queue_name.encode("utf-8"))')
